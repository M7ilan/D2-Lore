	...
	return (
		<div className="grid gap-8 content-start">
			...
			<motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.3 }} className="duration-0 relative">
				<Image quality={100} priority src={`https://www.bungie.net${bookDiff.displayProperties.iconSequences[1].frames[0]}`} className={clsx("hidden lg:block shadow-lg", { "opacity-100": isImageLoaded[book], "opacity-0": !isImageLoaded[book] })} width={1436} height={1840} alt="Book" onLoad={() => handleImageLoad(book)} />
